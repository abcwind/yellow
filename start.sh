...
PORT=46765
UUID=46b6a6b4-eb31-4bb4-a036-a4bd8bbfbba9
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/abcwind/yellow/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/abcwind/yellow/main/etc/xray.json
